...
export function generatePassword(length, options) {
  ...
  // Uniform selection via rejection sampling. A naive `b % chars.length` skews
  // the first `256 % chars.length` characters ~1.5x — a real entropy loss for a
  // security-facing generator. Reject the biased tail instead.
