...
const ALLOWED = {
  ...
  "ast-builder.js": 27,            // 20 stamps + parseAttributes param + comments + S159 §4.14 HTML `:`-shorthand synthesis gate (intra-stage read of BS's write-side `isComponent` stamp — `block.isComponent !== true` excludes components from body synthesis — + its doc comment; same allowed intra-stage-read family as lines 670/7212/7226)
