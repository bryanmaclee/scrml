...
describe("§59.12 value-native set — END-TO-END", () => {
  ...
  test("set operations produce CORRECT results at runtime", () => {
    ...
    const names = [
      ...
      "_scrml_map_from_entries", "_scrml_map_set_inplace", "_scrml_map_get",
      "_scrml_map_has", "_scrml_map_remove", "_scrml_map_size", "_scrml_map_key_order",
      "_scrml_map_insert", "_scrml_map_keys", "_scrml_map_entries",
    ];
