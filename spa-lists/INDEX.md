...
| **29** | **tailwind-utility-coverage** | 3 | tailwind-classes.js | **NEW S221 (flogence S14 triage) · fireable** — bare transition/duration/ease named-scale (extends bug-1) · bug-1 safelist/@apply sub-arc-2 · group/group-hover parent-state variant (NEW kind). Disjoint surface (safe with any lane). | NEW S221 |
