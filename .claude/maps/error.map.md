...
# RULE (a fire site, a trap, a prohibition); nothing keeps a row merely for having happened.
...
7. **RETIRED NOTE — `W-NAV-CHUNK-LOAD-FAILED`.** Prior generations of this map said "NOT implemented
