...
status: scoped-gated-hold     # dPA 2026-06-27 — forward-scoping MAP produced; GATE (multi-tenant `_{}` live) NOT met → HOLD gated, but no-regret moves surfaced. [was: candidate, banked S215]
...
status: complete     # banked → running → complete → ratified(by PA)  ·  COMPLETE dPA 2026-06-27 (ADVISORY) → artifact written, staged insight CANDIDATE, NOT ratified. [was: candidate, S225-consolidated from the S206 markup-lease DD + S221 W3.5 coupling]
