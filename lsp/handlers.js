...
export const ERROR_DESCRIPTIONS = {
  ...
  "E-MW-007": "More than one module in this build declares a request pipeline (handle() and/or a <program> middleware attribute). The onion is application-scope — a compiled server mounts exactly one. (SPEC §40.3.4)",
