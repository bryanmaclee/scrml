...
<!-- @review pr=577 verdict=carve-out by=S354-bryan date=2026-08-19 probe=file-set-verified-via-gh-pr-diff-name-only-single-path-docs-known-gaps-md-ZERO-code-paths-gap-filing-only-the-two-HIGHs-tenant-egress-twin-and-dev-server-inotify-leak-are-FILED-not-fixed-here note=gaps-filing-carve-out-the-dev-server-leak-it-files-is-the-same-inotify-exhaustion-the-579-dispatch-hit-and-documented-a-reaper-for -->
<!-- @review pr=576 verdict=carve-out by=S354-bryan date=2026-08-19 probe=file-set-verified-via-gh-pr-diff-name-only-single-path-handOffs-dpa-queue-md-ZERO-code-paths-recovery-of-dPA-round-2-queue-content-that-was-written-to-local-main-and-never-pushed note=continuity-recovery-carve-out -->
<!-- @review pr=575 verdict=carve-out by=S354-bryan date=2026-08-19 probe=file-set-verified-via-gh-pr-diff-name-only-five-paths-two-docs-changes-BRIEF-md-dispatch-archives-plus-docs-known-gaps-plus-handOffs-delta-log-plus-handOffs-dpa-queue-ZERO-code-paths-S353-banking-of-three-rulings-dpa-034-dpa-024-channel-nesting note=continuity-bank-carve-out-the-CODE-halves-of-two-of-these-three-rulings-ship-separately-as-578-and-580-and-each-got-its-own-independent-adversarial-pass-at-S354-so-the-carve-out-here-does-not-exempt-the-build -->
<!-- @review pr=574 verdict=carve-out by=S354-bryan date=2026-08-19 probe=file-set-verified-via-gh-pr-diff-name-only-five-paths-docs-changelog-plus-docs-pr-reviews-plus-hand-off-plus-handOffs-delta-log-plus-master-list-ZERO-code-paths-docs-only-S352-bryan-wrap note=continuity-wrap-carve-out -->
<!-- @review pr=573 verdict=carve-out by=S354-bryan date=2026-08-19 probe=file-set-verified-via-gh-pr-diff-name-only-single-path-docs-known-gaps-md-ZERO-code-paths-filing-of-g-lifecycle-read-detector-requires-a-dot-MED-whose-mechanism-was-PA-reproduced-by-execution-at-S352-both-sides-dot-read-fires-E-TYPE-001-bare-Shape-1-cell-read-compiles-clean note=gaps-filing-carve-out -->
