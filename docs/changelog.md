...
Current baseline (2026-05-23 **S123 CLOSE**). Full `bun run test` **19,933 pass / 0 fail / 175 skip / 1 todo across 754 files**; pre-commit gate (unit + integration + conformance) **14,059 pass / 0 fail / 92 skip / 1 todo across 715 files**. Native-parser canary strict-pass **998/1000** (unchanged from S121 baseline). S122 CLOSE baseline (pre-S123): 19,907 pass.
