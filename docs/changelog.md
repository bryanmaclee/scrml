...
Current baseline (2026-05-09 S74 close — PA-VERIFIED): **10,553 pass / 65 skip / 1 todo / 0 fail**. Net delta vs S73 close baseline (10,308 / 60 / 1 / 0): **+245 pass / +5 skip / +0 todo / +0 new fails** across 8 ship commits. Per-step: C12 +41, A6-1 +0 (spec only), C13 +40, C14 +37, B17.2 +28, C15 +32 (+5 skip), B17.3 +26, B17.4 +41. **S74 closed A1c Wave 4 (engines C12-C15) AND the entire B17.x family (parser + typer + codegen for `<onTransition>` + `effect=`) — §51.0.H surface SPEC-COMPLETE from compiler perspective.** 8 ships, 0 regressions, 2 F4 path-discipline incidents (both contained — A6-1 self-recovered pre-commit; C15 stashed + reconciled at landing).
