...
<<<<<<< HEAD
| live compiler source (`compiler/src`) | 255,823 lines across 196 files |
| test files | 1,467 |
=======
| live compiler source (`compiler/src`) | 254,872 lines across 195 files |
| test files | 1,465 |
>>>>>>> origin/main
| specification lines (`compiler/SPEC.md`) | 38,050 |
| conformance cases | 906 |
